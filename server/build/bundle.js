...
//How we have to setup the router when working with serverside rendering
...
exports.default = function (req, store, context) {
  ...
  //pulls the requested path off of the request object
  _react2.default.createElement(
  ...
  //extracts the data I created within the helmet tag on the *Page.js files
